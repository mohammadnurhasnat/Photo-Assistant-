...
export async function editPortrait(
  ...
  const prompts: Record<OutfitType, string> = {
    random_shirt: `A professional 2x2 passport-style portrait. Change the shirt to a neatly pressed ${color || "random professional colored"} shirt. ABSOLUTELY PRESERVE THE ORIGINAL FACE, FEATURES, AND IDENTITY EXACTLY. BOTH EARS MUST BE FULLY VISIBLE AND UNCOVERED. If ears are covered, hair must be moved back and ears realistically synthesized or placed appropriately for the face. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
    tshirt: `A professional 2x2 portrait wearing a clean, solid-colored T-shirt in ${color || "a random professional color"}. ABSOLUTELY PRESERVE THE ORIGINAL FACE AND IDENTITY. BOTH EARS MUST BE FULLY VISIBLE AND UNCOVERED. Synthesize/draw realistic ears if they are covered by hair or headwear. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
    suit: `A high-quality professional 2x2 passport-style portrait wearing a formal dark suit jacket (coat), a crisp shirt in ${color || "white"}, and a professional tie. ABSOLUTELY PRESERVE THE ORIGINAL FACE AND IDENTITY. BOTH EARS MUST BE FULLY VISIBLE AND UNCOVERED. Synthesize realistic ears if they are not visible. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
    female_dress: `A professional 2x2 passport-style portrait of an adult woman wearing a formal elegant Kameez (traditional professional dress) in ${color || "a random professional color"}. ABSOLUTELY PRESERVE THE ORIGINAL FACE AND IDENTITY. BOTH EARS MUST BE FULLY VISIBLE AND UNCOVERED. If ears are covered by hair or clothing, the AI must realistically place/synthesize uncovered ears based on the face shape. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
    ...
    female_blouse: `A professional 2x2 passport-style portrait of a woman wearing a formal professional blouse in ${color || "a random elegant color"}. ABSOLUTELY PRESERVE THE ORIGINAL FACE AND IDENTITY. BOTH EARS MUST BE FULLY VISIBLE and uncovered. Synthesize ears if necessary. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
    female_saree: `A high-quality professional 2x2 portrait of a woman wearing a traditional elegant Saree in ${color || "a random beautiful color"}. ABSOLUTELY PRESERVE THE ORIGINAL FACE AND IDENTITY. BOTH EARS MUST BE FULLY VISIBLE. Synthesize realistic ears if they are covered. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
    enhance: `A hyper-realistic, ultra-high resolution enhancement. Improve skin texture and sharpen eyes. PRESERVE THE ORIGINAL FACE EXACTLY. ENSURE BOTH EARS ARE FULLY VISIBLE AND UNCOVERED. If ears are missing or covered, realistically synthesize and place them according to the head shape. Pure white background. FILL THE ENTIRE FRAME. DO NOT add any white borders, frames, or margins around the image.`,
  };
